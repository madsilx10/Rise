...
const CONFIG = {
    NETWORK: {
        name: 'RISE Testnet',
        rpcUrl: 'https://rpc.testnet.riselabs.xyz', // Ganti dengan RPC yang kamu punya
        chainId: 11155931,
    ...
    // Swap Settings
    SWAP_AMOUNT: '0.001', // Amount dalam ETH unit (adjust sesuai kebutuhan)
...
class RiseAutoSwapper {
    ...
    async performSwap() {
        ...
        try {
            ...
            const amountIn = ethers.utils.parseUnits(CONFIG.SWAP_AMOUNT, fromTokenData.decimals);
